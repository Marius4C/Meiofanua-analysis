---
title: "Thesis stat PERMANOVA qualitative data nodule crevice nematods"
...
#handig voor nMDS plot: https://rstudio-pubs-static.s3.amazonaws.com/246172_1930ddfb5f064b2bab54b11016ab407e.html
...
```{r}
columns <- ncol(data)
num <- data %>% select(5:(columns - 4))  # select only the numeric values of the input data, otherwise an error when trying to generate distance matrix
